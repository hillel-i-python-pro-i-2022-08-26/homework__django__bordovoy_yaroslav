...
urlpatterns = [
    ...
    path("delete-contact/<int:pk>/", views.ContactsDeleteView.as_view(), name="delete_contact"),
    path("update-contact/<int:pk>/", views.ContactsUpdateView.as_view(), name="update_contact"),
